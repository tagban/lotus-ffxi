...
export inline std::array PCModelIDs{
    std::array{std::map<uint16_t, size_t>{{0, 7080}, {32, 0}},
               ...
               std::map<uint16_t, size_t>{{0, 41199}, {512, 66459}, {640, 81999}, {896, 105201}, {928, 0}}, std::map<uint16_t, size_t>{{0, 9416}, {256, 0}}},
    std::array{std::map<uint16_t, size_t>{{0, 10256}, {32, 0}},
               ...
               std::map<uint16_t, size_t>{{0, 42479}, {512, 66587}, {640, 82255}, {896, 105501}, {928, 0}}, std::map<uint16_t, size_t>{{0, 12592}, {256, 0}}},
    std::array{std::map<uint16_t, size_t>{{0, 13432}, {32, 0}},
               ...
               std::map<uint16_t, size_t>{{0, 43759}, {512, 66715}, {640, 82511}, {896, 105801}, {928, 0}}, std::map<uint16_t, size_t>{{0, 15768}, {256, 0}}},
    std::array{std::map<uint16_t, size_t>{{0, 16608}, {32, 0}},
               ...
               std::map<uint16_t, size_t>{{0, 45039}, {512, 66843}, {640, 82767}, {896, 106101}, {928, 0}}, std::map<uint16_t, size_t>{{0, 18944}, {256, 0}}},
    std::array{std::map<uint16_t, size_t>{{0, 19784}, {32, 0}},
               ...
               std::map<uint16_t, size_t>{{0, 46319}, {512, 66971}, {640, 83023}, {896, 106401}, {928, 0}}, std::map<uint16_t, size_t>{{0, 22120}, {256, 0}}},
    std::array{std::map<uint16_t, size_t>{{0, 22960}, {32, 0}},
               std::map<uint16_t, size_t>{{0, 19816}, {256, 65115}, {320, 77391}, {576, 99427}, {608, 104241}, {672, 0}},
               std::map<uint16_t, size_t>{{0, 20072}, {256, 65179}, {320, 77647}, {576, 99459}, {608, 104305}, {672, 0}},
               std::map<uint16_t, size_t>{{0, 20328}, {256, 65243}, {320, 77903}, {576, 99491}, {608, 104369}, {672, 0}},
               std::map<uint16_t, size_t>{{0, 20584}, {256, 65307}, {320, 78159}, {576, 99523}, {608, 104433}, {672, 0}},
               ...
               std::map<uint16_t, size_t>{{0, 21096}, {512, 65435}, {640, 78671}, {896, 108501}, {928, 0}},
               std::map<uint16_t, size_t>{{0, 46319}, {512, 66971}, {640, 83023}, {896, 106401}, {928, 0}}, std::map<uint16_t, size_t>{{0, 22120}, {256, 0}}},
    std::array{std::map<uint16_t, size_t>{{0, 23184}, {32, 0}},
               ...
               std::map<uint16_t, size_t>{{0, 47599}, {512, 67099}, {640, 83279}, {896, 106701}, {928, 0}}, std::map<uint16_t, size_t>{{0, 25520}, {256, 0}}},
    std::array{std::map<uint16_t, size_t>{{0, 26360}, {32, 0}},
               ...
               std::map<uint16_t, size_t>{{0, 48879}, {512, 67227}, {640, 83535}, {896, 107001}, {928, 0}}, std::map<uint16_t, size_t>{{0, 28696}, {256, 0}}}};
} // namespace ActorData
